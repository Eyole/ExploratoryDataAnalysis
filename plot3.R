...
#
#File: plot3.R Submetering Vs Date Time.
#
#
...
run_plotthree <<- function ()
{
  ...
  legend('topright', names(df.hpc.subset)[7:9],lty = 1, col = c("black","red","blue"))
  
  mtext("Sub Metering & Vs Date & Time", side=3, outer=TRUE, line=-3)
